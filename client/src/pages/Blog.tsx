...
const updates: UpdateItem[] = [
  ...
  },
  {
    ...
    descriptionEn: 'We\'ve significantly improved the online multiplayer experience with better connection stability, faster matchmaking, and reduced lag. Rooms now support shareable room codes for easy friend invites.',
    descriptionJa: '接続の安定性向上、マッチメイキングの高速化、遅延の削減により、オンラインマルチプレイヤー体験を大幅に改善しました。友達を簡単に招待できるルームコードをサポートするようになりました。',
    type: 'improvement',
    icon: FaGlobe,
  },
  {
