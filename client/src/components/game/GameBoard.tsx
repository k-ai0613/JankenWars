...
const GameBoard: React.FC = () => {
  ...
  return (
    <div className="relative">
      ...
      {/* Main board */}
      <div className="w-full max-w-3xl mx-auto aspect-square grid grid-cols-6 gap-2 bg-gradient-to-br from-amber-100 to-amber-200 p-4 rounded-xl shadow-lg border-4 border-amber-300 relative z-10">
