...
const GameBoard: React.FC = () => {
  ...
  return (
    <div className="relative">
      ...
      {/* Main board */}
      <div className="w-full max-w-md mx-auto aspect-square grid grid-cols-6 gap-1.5 bg-gradient-to-br from-amber-100 to-amber-200 p-3 rounded-xl shadow-lg border-4 border-amber-300 relative z-10">
